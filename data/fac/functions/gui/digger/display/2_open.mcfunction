...
item replace block ~ ~ ~ container.16 with gray_wool{gui: {id: 4, display: 2, digger: 1}, display: {Lore: ['[{"italic":false,"color":"gray","text":"석탄을"},{"color":"red","text":" 모두 "},{"text":"채굴기에 넣습니다."}]'], Name: '{"italic":false,"bold":true,"color":"#99FF99","text":"기타"}'}, HideFlags: 255} 64
item replace block ~ ~ ~ container.22 with barrier{gui: {id: 5, display: 2, digger: 1, back: 1}, display: {Lore: ['{"italic":false,"color":"gray","text":"이전 화면으로 돌아갑니다."}', '{"italic":false,"color":"gray","text":"클릭하면 이동합니다."}'], Name: '{"italic":false,"bold":true,"color":"#FF0000","text":"돌아가기"}'}, HideFlags: 255}
